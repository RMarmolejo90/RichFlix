...
const MovieList = ({fetchUrl, name, listName}: Props) => {
  ...
  return (
    <div className='flex flex-col group'>
      <Link href={`/list/${name}`} className='hover:font-bold hover:bg-gradient-to-b from-transparent via-red-950 to-transparent border-t-2 border-l-2 rounded-tl-3xl border-red-500'>
